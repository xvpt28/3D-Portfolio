  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <label className="flex flex-col xl:text-[18px]">
            <span className="text-white font-medium mb-4 ml-1">Your Name</span>
            <input
              type="text"
              name="name"
              value={form.name}
          ...
          <label className="flex flex-col xl:text-[18px]">
            <span className="text-white font-medium mb-4 ml-1 ">
              Your email
            </span>
            <input
              type="email"
